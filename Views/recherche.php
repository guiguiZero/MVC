	     ...
	     <div class="row no-gutters">
             ...
             <article class="gallery-wrap">
	              <div class="img-big-wrap">
	                 <a href="#"><img src="<?php echo $data['imgProduit'] ?>"></a>
	                </div> <!-- img-big-wrap.// -->
                ...
                <article class="content-body">
                  ...
                  <h2 class="title"><?php echo $data['ProdName'] ?></h2>

                  <div class="mb-3">
	                   <var class="price h4"><?php echo $data['Price'] ?></var>
                    ...
                    <hr>
	                   <div class="row">
		                     <div class="form-group col-md flex-grow-0">
                                   ...
                                   <form class='setProduct' action='/MVC/panier/setPanier' method='post'>
                                     <input id=idUser name=Userid type=hidden value="<?php echo $idUser ?>">
                                     <input id=idProd name=Prodid type=hidden value="<?php echo $data['idProduit'] ?>">
